...
startMsg = "Привет! Меня зовут BestCryptoInsideBot," \
           ...
           "Ну что, начнем наше путешествие по социальной торговой платформе? Или сначала ознакомитесь с отзывами?\n\n" \
           "<b>Ваш ID: %s</b>"
...
profitMsg = "Активировав подписку на InsightTradeBot вы получите:\n" \
